...
public class FutureValueTest {
    ...
    public void testSetRatePeriod() {
        ...
        assertEquals("The Payment Amount is 0.0, the Rate Period is 8.0, the Period is 0.0, and the Periodic Payment 0.0.", testCalculator.toString());
    }
    ...
    public void testSetPaymentAmountAndRatePeriod() {
        ...
        assertEquals("The Payment Amount is 1.0, the Rate Period is 2.0, the Period is 0.0, and the Periodic Payment 0.0.", testCalculator.toString());
    }
    ...
    public void testSetRatePeriodAndPeriod() {
        ...
        assertEquals("The Payment Amount is 0.0, the Rate Period is 1.0, the Period is 2.0, and the Periodic Payment 0.0.", testCalculator.toString());
    }
    ...
    public void testGetRatePeriod() {
        InvestmentCalculator testCalculator = new InvestmentCalculator();
        testCalculator.setRatePeriod(1);
        assertEquals(1.0, testCalculator.getRatePeriod(), 0);
    }
    ...
    public void testGetPeriodicPaymentMultipleValues() {
        ...
        testCalculator.setRatePeriod(.03);
